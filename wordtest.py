...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/itsc/Desktop/심리학 조별과제/221113 프로그래밍/Eojeol_NonEojeol_Experiment_trial/wordtest.py',
...
for thisPractice in practice:
    ...
    text_4.setText('')
    # keep track of which components have finished
    ITIComponents = [key_resp_2, text_4]
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED and not waitOnFlip:
            theseKeys = key_resp_2.getKeys(keyList=['z','slash'], waitRelease=False)
            _key_resp_2_allKeys.extend(theseKeys)
            if len(_key_resp_2_allKeys):
                key_resp_2.keys = _key_resp_2_allKeys[0].name  # just the first key pressed
                key_resp_2.rt = _key_resp_2_allKeys[0].rt
                # was this correct?
                if (key_resp_2.keys == str(coranswer)) or (key_resp_2.keys == coranswer):
                    key_resp_2.corr = 1
                else:
                    key_resp_2.corr = 0
    ...
    elif key_resp_2.corr or key_resp_2.keys == coranswer:
        msg_pr = "정답입니다!"
    else:
        msg_pr= "오답입니다!\n"
    print(msg_pr, key_resp_2.keys, key_resp_2.corr)
    # keep track of which components have finished
